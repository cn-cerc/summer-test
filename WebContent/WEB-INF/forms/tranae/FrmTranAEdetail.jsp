...
<div align="center">
    <div>
        <h1>单身详细单笔数据</h1>
        <form action="FrmTranAEdetail.modify" method="post">
            ...
            <p>当前库存：<input type="text" name="Unit" value="${item.stock}"  readonly="readonly"></input></p>
            <p>调整数量：<input type="text" name="Num" value="${item.num}" ></input></p>
            <input type="submit" name="delete" value="删除"></input>
            <input type="submit" name="save" value="保存"></input>
            <p><a href="FrmTranAEInfo?tbno=${item.tbno}">返回</a></p>
        </form>
    </div>
</div>
