...
<script>
    ...
    function onTestClick() {
        ...
        browser.req = {
        		"homeUrl": "/forms/FrmScanProduct",
        		"viewUrl": "/forms/FrmScanProduct.view",
        		"postUrl": "/forms/FrmScanProduct.save",
        		"title": "零售单扫描"};
...
<body style="font-size:2em;">
    <div style="text-align: center; padding-top: 2em;">
        ...
        <div style="text-align: center; padding-top: 2em;"><a href="FrmDefault">进入首页</a></div>
    </div>
	<div style="text-align: center; padding-top: 2em;">
