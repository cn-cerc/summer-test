...
<div>
    <div>
      ...
      <form action="FrmTranBCbInfo.submit" method="Post">     
      <table align="center" width="90%">   
         ...
         <tr>
           <th>  
             <p>客户名称: <input type="text" name="CusName" value="${item.cusname}"/></p>       
           </th>
           <th>
    ...
    <table align="center" width="90%">
      ...
      <tr>
          ...
          <td align="center" >
             <a href="FrmTranBCbModify?tbno=${item.tbno}&it=${item.it}">内容</a> | 
          </td>
      </tr>
      </c:forEach>
      </c:if>
  ...
  <div align="left">
    <a href="FrmTranBCbAppend?tbno=${item.tbno}">新增</a>
