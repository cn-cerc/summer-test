...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    <xsl:template match="/">
        <center>
            <h2>
                <xsl:value-of select="html/head/title"/>(<xsl:value-of select="html/head/system/@code"/>)
                <h3>
        ...
        <table border="1" width="100%" bordercolorlight="#000000" bordercolordark="#FFFFFF" bordercolor="#000000" cellspacing="0" cellpadding="3">
            <tr bordercolorlight="#000000" bordercolordark="#FFFFFF" bgcolor="#66FF99">
                ...
                <td align="center"><b>功能名称</b></td>
                <td align="center"><b>等级</b></td>
                <td align="center"><b>文档号</b></td>
                <td align="center"><b>备注</b></td>
                <td align="center"><b>隐藏否</b></td>
                <td align="center"><b>移除否</b></td>
            ...
            <xsl:for-each select="html/body/section">
                ...
                <td align="center">
	                <xsl:element name="a">
					<xsl:attribute name="href">http://appdocs.sinaapp.com/helpme.php?id=<xsl:value-of select="@docid"/></xsl:attribute>
					</xsl:element>
                	<xsl:value-of select="@docid"/><br/>
                </td>
                <td>
                	<xsl:value-of select="remark"/><br/>
                </td>
                <td align="center">
                	<xsl:value-of select="@hide"/><br/>
                </td>
                <td align="center">
                	<xsl:value-of select="@delete"/><br/>
                </td>
                <td>
                	<xsl:value-of select="@qcdate"/><br/>
                </td>
                    </tr>
                </xsl:for-each>
            </xsl:for-each>
