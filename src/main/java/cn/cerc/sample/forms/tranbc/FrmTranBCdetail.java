...
public class FrmTranBCdetail extends AbstractForm {
    @Override
    public IPage execute() {
        JspPage jspPage = new JspPage(this, "tranbc/FrmTranBCdetail.jsp");
        String tbno = this.getRequest().getParameter("tbno");
        String it = this.getRequest().getParameter("it");

        LocalService svr = new LocalService(this);
        svr.setService("SvrTranBC.searchDetailTranB");
    ...
    public IPage modify() {
        ...
        if (save != null && save.equals("保存")) {
            LocalService svr = new LocalService(this);
            svr.setService("SvrTranBC.modifyTranB");
        ...
        if (delete != null && delete.equals("删除")) {
            LocalService svr = new LocalService(this);
            svr.setService("SvrTranBC.deleteTranB");
