...
public class FrmTranBCb extends AbstractForm {
    @Override
    public IPage execute() {
        // 新增加商品资料
        JspPage jspPage = new JspPage(this, "tranbc/FrmTranBCb.jsp");
    ...
    public IPage appendTranB() {
        ...
        if (submit != null) {
            ...
            svr.setService("SvrTranBC.appendTranB");
    ...
    public IPage delete() {
         ...
         * 
         */
        return new RedirectPage(this, "FrmTranBCb");
    }
