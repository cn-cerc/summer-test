...
public class FrmTranAEInfo extends AbstractForm {
    ...
    public IPage execute() {
        ...
        svr.setService("SvrTranAE.searchSingleTranH");
        ...
        svrTranb.setService("SvrTranAE.searchSingleTranB");
        ...
        while (dsTranb.fetch()) {
            ...
            tranBitem.setStock(dsTranb.getDouble("Stock_"));
            items.add(tranBitem);
        }
    ...
    public IPage delete() {
         ...
         * 
         */
        return new RedirectPage(this, "FrmTranAE");
    }
