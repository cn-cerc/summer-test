...
public class FrmTranABdetail extends AbstractForm {
    ...
    public IPage execute() {
        JspPage jspPage = new JspPage(this, "tranab/FrmTranABdetail.jsp");
        String tbno = this.getRequest().getParameter("tbno");
        String it = this.getRequest().getParameter("it");

        LocalService svr = new LocalService(this);
        svr.setService("SvrTranAB.searchDetailTranB");
    ...
    public IPage modify() {
        ...
        if (save != null && save.equals("保存")) {
            LocalService svr = new LocalService(this);
            svr.setService("SvrTranAB.modifyTranB");
        ...
        if (delete != null && delete.equals("删除")) {
            LocalService svr = new LocalService(this);
            svr.setService("SvrTranAB.deleteTranB");
